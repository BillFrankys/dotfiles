...
echo "### Config git untracked files:"
CARGO_HOME="$HOME/.local/share/cargo"  cargo binstall -y --force cargo-update nu alacritty alacritty-opacity asdf atuin colortty fd-find felix  hyperfine pastel pueue ripgrep starship trashy vivid  zoxide
